...
export const getIapFormattedPriceAsync = (productIdentifier, defaultPrice) => window.ipcRenderer.invoke('get-iap-formatted-price', productIdentifier, defaultPrice);
